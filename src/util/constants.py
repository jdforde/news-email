...
body {font-family: 'Chivo', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 20px 18px 20px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><br></div>
...
<div style="font-family: inherit; text-align: center"><span style="color: #a70c0c; font-size: 14px; font-family: &quot;lucida sans unicode&quot;, &quot;lucida grande&quot;, sans-serif">If you would like to unsubscribe, please respond to this email indicating so.</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
                                      </tr>
